      ...
      <Col>
        ...
        <S.Card title={t('dataDisplay.avatars.groups')}>
          <Group
            ...
            size={45}
            maxStyle={{
              color: theme.commonColors.red,
              backgroundColor: theme.commonColors.orange
            }}>
            <Avatar size={45} src="https://joeschmoe.io/api/v1/random" />
            <Avatar
              size={45}
              style={{ backgroundColor: theme.commonColors.red }}>
              K
            </Avatar>
            <Tooltip title={t('dataDisplay.avatars.user')} placement="top">
              <Avatar
                size={45}
                style={{ backgroundColor: theme.commonColors.green }}
                icon={<UserOutlined />}
              />
            </Tooltip>
            <Avatar
              size={45}
              style={{ backgroundColor: theme.commonColors.blue }}
