...
const OptionsDropdown: React.FC<IProps> = ({name, handleOutput, virtualPin, customer, states}) => {
  ...
  return (
    ...
    <div style={{ width: '30px', height: '30px', borderRadius: '50%', backgroundColor: buttonColor, marginRight: '5px' }} />
    <Dropdown overlay={menu} placement="bottomCenter">
      <Button style={{ backgroundColor: stateColor }} loading={ loading}>{selectedOption}</Button>
    </Dropdown>
  </div>
  </Card>
  );
