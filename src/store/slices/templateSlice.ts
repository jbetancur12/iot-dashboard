import { TemplateData, TemplateDataResponse, createTemplate, deleteTemplate, getTemplate, getTemplates, updateTemplate } from '@app/api/template.api';
...
export const doCreateTemplate = createAsyncThunk('templates/create', async (templateData: TemplateData) => createTemplate(templateData));
...
export const doUpdateTemplate= createAsyncThunk(
  ...
  export const doDeleteTemplate = createAsyncThunk('templates/delete', async (templateId: string) => deleteTemplate(templateId));


  export const retrieveTemplates = createAsyncThunk('templates/retrieve', async () => getTemplates());

  export const retrieveTemplate = createAsyncThunk('templates/retrieveOne', async (templateId: any) => getTemplate(templateId))
