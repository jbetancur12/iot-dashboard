import { VariableData, VariableDataResponse, createVariable, deleteVariable, getVariable, getVariables, updateVariable } from '@app/api/variable.api';
...
export const doUpdateVariable= createAsyncThunk(
  ...
  export const retrieveVariable = createAsyncThunk('variables/retrieveOne', async (variableId: any) => getVariable(variableId))
