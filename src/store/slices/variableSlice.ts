...
export const doCreateVariable = createAsyncThunk('variables/create', async (variableData: VariableData) =>
...
export const doDeleteVariable = createAsyncThunk('variables/delete', async (variableId: string) =>
  deleteVariable(variableId),
);

export const retrieveVariables = createAsyncThunk('variables/retrieve', async () => getVariables());

export const retrieveVariable = createAsyncThunk('variables/retrieveOne', async (variableId: any) =>
