import { CustomerData, CustomerDataResponse, createCustomer, deleteCustomer, getCustomer, getCustomers, updateCustomer } from '@app/api/customer.api';
...
export const doUpdateCustomer= createAsyncThunk(
  ...
  export const retrieveCustomer = createAsyncThunk('customers/retrieveOne', async (customerId: any) => getCustomer(customerId))
