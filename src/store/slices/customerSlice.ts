...
export const doCreateCustomer = createAsyncThunk('customers/create', async (customerData: CustomerData) =>
...
export const doDeleteCustomer = createAsyncThunk('customers/delete', async (customerId: string) =>
  deleteCustomer(customerId),
);

export const retrieveCustomers = createAsyncThunk('customers/retrieve', async () => getCustomers());

export const retrieveCustomer = createAsyncThunk('customers/retrieveOne', async (customerId: any) =>
